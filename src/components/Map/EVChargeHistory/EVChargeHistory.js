...
const EVChargeHistory = ({ show, onHide }) => {
  const history = [
    ...
    { id: 4, location: { city: 'London', country: 'England, UK' }, currentBatteryCharge: 85, prevBatteryCharge: 70, durationTimeInMin: 35, charge: true, name: 'ChargePoint - 123 Road', location: 'A12 B34 London, UK' },
    ...
    { id: 7, location: { city: 'London', country: 'England, UK' }, currentBatteryCharge: 95, prevBatteryCharge: 60, durationTimeInMin: 75, charge: true, name: 'ChargePoint - 123 Road', location: 'A12 B34 London, UK' }
  ]
